...
Для MVP утверждён асинхронный профиль B с задачами. Реализация HTTP-границы
относится к Stage 8 Macro 2.
...
Для MVP утверждены ровно три маршрута, описанные ниже. Их реализация и
контрактные HTTP-тесты относятся к Stage 8 Macro 2.
...
Для Stage 8 Macro 2 утверждён минимальный механизм HTTP Basic. Точный дизайн
экранов остаётся открытым до реализации Macro 2.
