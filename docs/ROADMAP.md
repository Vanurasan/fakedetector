...
Ближайшее действие: выполнить независимый финальный аудит Stage 7
Критические блокеры: отсутствуют
Реализация программы: Этапы 1–6 завершены; Stage 7 ожидает независимый финальный аудит; Stage 8 остаётся NOT_STARTED
...
качества реализации успешно пройден. Формальное закрытие Stage 7 ожидает
независимый финальный аудит; Stage 8 остаётся `NOT_STARTED`.
