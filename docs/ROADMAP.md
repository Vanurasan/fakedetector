...
Ближайшее действие: реализовать проверенный файловый дескриптор с техническими параметрами
...
- [ ] реализовать файловые дескрипторы;
  ...
  - [ ] реализовать проверенный файловый дескриптор с техническими параметрами;
