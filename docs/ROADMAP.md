...
- [x] Macro 2 — утверждённые асинхронный HTTP API и WebUI с HTTP Basic;
  реализация завершена и ожидает проверки владельцем и независимого финального
  аудита.
...
`IN_PROGRESS` в ожидании проверки владельцем и независимого финального аудита;
`DONE/CLOSED` до отдельного решения владельца не устанавливается.
