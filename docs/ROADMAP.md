...
Ближайшее действие: Stage 8 Macro 2 — реализовать утверждённые HTTP API и WebUI
Критические блокеры: отсутствуют
Реализация программы: Этапы 1–7 завершены; Stage 8 Macro 1 реализован, Macro 2 ожидает выполнения
...
| 8 | JSON, API и WebUI | IN_PROGRESS | Хранение результатов готово; API/WebUI ожидают Macro 2 |
...
`IN_PROGRESS`: хранение результатов Macro 1 реализовано, Macro 2 ожидает
выполнения.
...
Stage 7 имеет статус `DONE`. Следующее действие текущего Stage 8 — Macro 2.
...
- [ ] Macro 2 — утверждённые асинхронный HTTP API и WebUI с HTTP Basic.
...
- [ ] реализовать утверждённый HTTP Basic;
...
Macro 1 завершён; общий критерий Stage 8 остаётся невыполненным до реализации и
проверки Macro 2.
